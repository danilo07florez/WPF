...
namespace OPS.OSPDataSetTableAdapters {
    ...
    public partial class UsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Usuario] WHERE (([IdUsuario] = @Original_IdUsuario) AND ([Nomb" +
                "re] = @Original_Nombre) AND ([Apellido] = @Original_Apellido))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuario] ([Nombre], [Apellido]) VALUES (@Nombre, @Apellido);\r\n" +
                "SELECT IdUsuario, Nombre, Apellido FROM Usuario WHERE (IdUsuario = SCOPE_IDENTIT" +
                "Y())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuario] SET [Nombre] = @Nombre, [Apellido] = @Apellido WHERE (([IdUsuario] = @Original_IdUsuario) AND ([Nombre] = @Original_Nombre) AND ([Apellido] = @Original_Apellido));
SELECT IdUsuario, Nombre, Apellido FROM Usuario WHERE (IdUsuario = @IdUsuario)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::OPS.Properties.Settings.Default.OSPConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IdUsuario, Nombre, Apellido FROM dbo.Usuario";
        ...
        public virtual int Fill(OSPDataSet.UsuarioDataTable dataTable) {
        ...
        public virtual OSPDataSet.UsuarioDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            OSPDataSet.UsuarioDataTable dataTable = new OSPDataSet.UsuarioDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(OSPDataSet.UsuarioDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(OSPDataSet dataSet) {
        ...
        public virtual int Delete(int Original_IdUsuario, string Original_Nombre, string Original_Apellido) {
        ...
        public virtual int Update(string Nombre, string Apellido, int Original_IdUsuario, string Original_Nombre, string Original_Apellido, int IdUsuario) {
            if ((Nombre == null)) {
                throw new global::System.ArgumentNullException("Nombre");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Apellido, int Original_IdUsuario, string Original_Nombre, string Original_Apellido) {
            return this.Update(Nombre, Apellido, Original_IdUsuario, Original_Nombre, Original_Apellido, Original_IdUsuario);
        }
    }
